...
describe("_Range", function() {
  ...
  describe("#each", function() {
    it("should iterate with a callback", function() {
      ...
      var oneToOneHundred = new _Range(1, 100);
      var sum = 0;
  ...
  it("should be able to count backwards", function() {
    var countdown = new _Range(10, 0, -1);
    var elements = [];
  ...
  it("should be able to count down by 2", function() {
    var countdown = new _Range(10, 0, -2); // Let's count down by twos
    var elements = [];
    countdown.each(function(val) {
      elements.push(val);
    });
